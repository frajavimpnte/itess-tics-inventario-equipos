...
use Inventario\Controllers\ErrorController;
use Inventario\Controllers\UsuarioController;
...
class Router {
    ...
    private function executeController(
        ...
        $controllerName = '\Inventario\Controllers\\' . $info['controller'] . 'Controller';
